...
_G.packer_plugins = {
  ...
  neon = {
    loaded = true,
    path = "/home/anton/.local/share/nvim/site/pack/packer/start/neon",
  ...
  ["nvim-treesitter-textobjects"] = {
    loaded = true,
    path = "/home/anton/.local/share/nvim/site/pack/packer/start/nvim-treesitter-textobjects",
  ...
  ["vim-pandoc-syntax"] = {
    loaded = true,
    path = "/home/anton/.local/share/nvim/site/pack/packer/start/vim-pandoc-syntax",
